...
//    navigator.register("https://home", <#T##factory: ViewControllerFactory##ViewControllerFactory##(URLConvertible, [String : Any], Any?) -> UIViewController?#>)
    navigator.handle("navigator://alert", self.alert(navigator: navigator))
    navigator.handle("navigator://alert/patch/jjj", self.alert(navigator: navigator))
